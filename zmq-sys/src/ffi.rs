...
pub const ZMQ_THREAD_AFFINITY_CPU_PIN: u32 = 9001;
...
/// Vibe custom: per-connection SO_MAX_PACING_RATE in bytes/sec (0 = unpaced).
pub const ZMQ_TCP_MAX_PACING_RATE: u32 = 9000;
